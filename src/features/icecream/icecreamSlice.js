...
const icecreamSlice = createSlice({
     ...
     * 
     * # EXAMPLE:
     * i want to make promotion for this store. every cake purcashed, the store will also give an ice cream for cutomer.
     ...
     * icecream.ordered();
     * 
     * the code may looks fine, but what if when we want to access more that 1 store.
